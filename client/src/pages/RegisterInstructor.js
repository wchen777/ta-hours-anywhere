...
const REGISTER_INSTRUCTOR = gql`
  mutation registerInstructor($username: String!, $email: String! $password: String!, $confirmPassword: String!) {
    registerInstructor(username: $username email: $email password: $password confirmPassword: $confirmPassword) {
...
export default function RegisterInstructor(props) {
    ...
    const [regInst, { loading }] = useMutation(REGISTER_INSTRUCTOR, {
        update(_, __){
    ...
    return (
         <Row className='bg-white py-5 justify-content-center'>
           ...
           <Form onSubmit={submitRegisterForm}>
            ...
            <br/>
            <br/>
            <small>Already have an instructor account? <Link to='/login-instructor'> Login here</Link></small>
            <br/>
